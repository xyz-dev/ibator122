...
public class RenameExampleClassPlugin extends IbatorPluginAdapter {
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        ...
        introspectedTable.setCountByExampleStatementId(exampleToCriteria(introspectedTable.getCountByExampleStatementId()));
        introspectedTable.setDeleteByExampleStatementId(exampleToCriteria(introspectedTable.getDeleteByExampleStatementId())); //$NON-NLS-1$
        introspectedTable.setSelectByExampleStatementId(exampleToCriteria(introspectedTable.getSelectByExampleStatementId())); //$NON-NLS-1$
        introspectedTable.setSelectByExampleWithBLOBsStatementId(exampleToCriteria(introspectedTable.getSelectByExampleWithBLOBsStatementId())); //$NON-NLS-1$
        introspectedTable.setUpdateByExampleStatementId(exampleToCriteria(introspectedTable.getUpdateByExampleStatementId())); //$NON-NLS-1$
        introspectedTable.setUpdateByExampleSelectiveStatementId(exampleToCriteria(introspectedTable.getUpdateByExampleSelectiveStatementId())); //$NON-NLS-1$
        introspectedTable.setUpdateByExampleWithBLOBsStatementId(exampleToCriteria(introspectedTable.getUpdateByExampleWithBLOBsStatementId())); //$NON-NLS-1$
    ...
    private String exampleToCriteria(String example) {
    	return example.replaceAll("Example", "Criteria");
    }
